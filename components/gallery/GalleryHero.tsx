    ...
    <section className="relative overflow-hidden bg-[#fafafc] pt-24 pb-16 md:pt-32 md:pb-24 border-b border-gray-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-[#0f172a] leading-tight mb-6 tracking-tight">
          Galeri & <span className="italic text-primary font-serif">Momen Kegiatan</span>
        </h1>

        <p className="text-lg text-gray-500 max-w-2xl mx-auto leading-relaxed">
          Lihat keseruan belajar, berbagai event menarik, dan fasilitas yang kami sediakan untuk mendukung proses belajar peserta didik.
        </p>
      </div>
    </section>
  );
