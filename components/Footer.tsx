...
export default function Footer() {
  ...
  const email = settings.contact_email || "smartinenglish.smile56@gmail.com";
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-colors" 
                aria-label="TikTok"
              >
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">{displayPhone}</span>
              </li>
              <li className="flex items-center">
