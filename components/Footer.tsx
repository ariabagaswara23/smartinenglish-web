...
export default function Footer() {
  return (
    <footer className="bg-[#0f172a] text-white pt-16 pb-8 relative overflow-hidden mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-10 md:pt-16">
        
        {/* CTA Section (WhatsApp) */}
        <div className="bg-primary rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col lg:flex-row items-center justify-between mb-20 transform -translate-y-4 hover:-translate-y-6 transition-transform duration-500 border border-blue-500/30 relative overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-48 h-48 bg-yellow-400/20 rounded-full blur-2xl pointer-events-none"></div>
          
          <div className="lg:w-2/3 mb-8 lg:mb-0 relative z-10 text-center lg:text-left">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-white">Siap Memulai Perjalanan Belajar Anda?</h3>
            <p className="text-blue-100 text-lg max-w-2xl">Konsultasikan kebutuhan belajar bahasa Inggris Anda bersama tim kami secara gratis. Kami siap membantu Anda memilih program yang paling tepat.</p>
          </div>
          
          <div className="lg:w-1/3 flex justify-center lg:justify-end relative z-10">
            <a 
              href="https://wa.me/6285950712155"
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex items-center bg-[#25D366] hover:bg-[#20b858] text-white px-8 py-4 rounded-full font-bold text-lg transition-all shadow-lg hover:shadow-[#25D366]/50 hover:scale-105"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} smArt in english. All rights reserved.
          </p>
