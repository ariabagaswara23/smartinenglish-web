        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12 mb-16">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex space-x-4">
              <a href="https://www.tiktok.com/@smile_smartinenglish" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-gray-400 hover:bg-primary hover:text-white transition-colors" aria-label="TikTok">
